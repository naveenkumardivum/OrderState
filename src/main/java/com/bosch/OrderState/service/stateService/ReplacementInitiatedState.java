...
@Service
public class ReplacementInitiatedState implements OrderState {

    private static final String STATE = ApplicationMessageConstants.STATES.REPLACMENT_INITIATED.toString();
