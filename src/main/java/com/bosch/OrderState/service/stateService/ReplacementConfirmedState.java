...
@Service
public class ReplacementConfirmedState implements OrderState {

    private static final String STATE = ApplicationMessageConstants.STATES.REPLACEMENT_CONFIRMED.toString();
