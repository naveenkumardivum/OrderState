...
@Service
public class RejectedWithPODState implements OrderState {

    private static final String STATE = ApplicationMessageConstants.STATES.REJECTED_WITH_POD.toString();
