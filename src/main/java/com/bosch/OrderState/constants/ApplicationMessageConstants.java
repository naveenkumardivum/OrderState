...
public class ApplicationMessageConstants {
    ...
    public enum STATES {
        ORDER_PLACED, ORDER_CONFIRMED, READY_TO_SHIP, INTRANSIT, POD_UPLOADED, BUYER_APPROVED, PAYMENT_PROCESSED, REPLACMENT_INITIATED, REPLACEMENT_CONFIRMED, RETURN_INITIATED, RETURN_CONFIRMED, ORDER_RETURNED, REFUND_INITIATED, BUYER_REJECTED, REJECTED_WITH_POD, REJECTED, ORDER_CANCEL_CONFIRMED, ORDER_CANCEL_INITIATED, DRAFT
    }
